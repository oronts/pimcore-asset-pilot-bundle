    ...
    private function service(
        ...
        $service = $this->getMockBuilder(ReviewedObjectOperationService::class)
            ->setConstructorArgs([
                ...
                new NullLogger(),
                $lease ?? $this->createMock(RunItemLease::class),
                new ObjectSaveDrain($this->createMock(LoopGuard::class), $this->createMock(OrganizeDispatcher::class), $this->createMock(\Oronts\AssetPilotBundle\Service\AutomaticOrganizeIntentStoreInterface::class), $this->createMock(\Doctrine\DBAL\Connection::class), new NullLogger()),
