...
class AssetReorganizerTest extends TestCase
{
    ...
    private function reorganizer(
        ...
        return new class ($resolver, $organizer, $bus, $assetIds, $objectsById) extends AssetReorganizer {
            ...
            public function __construct(AssetDependencyResolver $r, AssetOrganizer $o, MessageBusInterface $b, private array $assetIds, private array $objectsById)
            {
    ...
    {
        $organizer = $this->createMock(AssetOrganizer::class);
        $result = $this->reorganizer([1], [1 => [10]], $organizer, $this->createMock(MessageBusInterface::class), [])->reorganizeFolder('/Staging');
